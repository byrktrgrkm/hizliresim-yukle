...
<div class="row">
    <div class="col">
        ...
        <img class="share-image" id="post_image" src="<?=$share["isPass"] ? get_local_image("/no-image-icon.png") : share_image($share['folder'],$images[0]['image'])?>" alt="">
        ...
        <div id="post_container_istatistik" class="row p-1 border border-primary align-items-center text-secondary mt-3 m-2 <?=($share['isPass'] ? 'd-none' :'')?>">
            <div class="col-2">
                ...
                <?php else: ?>
                    <?php foreach($comments['data'] as $comment):?>
                        <div class="col item-user  p-2 my-1" style="    font-size: 13px;">
                            <div class="row">
                                <div class="col-2 text-center ">
                                    <img src="<?=(empty($comment['image']) ? get_local_image("resize/ninja-default.png") : avatar_url($comment['image']))?>" onerror="this.src = '<?=get_local_image('resize/ninja-default.png')?>';" alt="">
                                </div>
                                <div class="col-10">
